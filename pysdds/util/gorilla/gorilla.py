...
class ValuesEncoder:
    ...
    def __init__(self, bit_array=None, float_format='f64'):
        ...
        self.n_bits_length_of_the_meaningful_xored_value = INIT_CONSTS[
            float_format]['n_bits_length_of_the_meaningful_xored_value']
        self.pack_format = INIT_CONSTS[float_format]['pack_format']
    ...
    def encode_next(self, value: float) -> bool:
        ...
        meaningful_xored_value = xored_value[self.previous_n_leading_zeros:self.n_bits_value -
